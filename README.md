Ecanverter can be used to load [CAN BUS](https://en.wikipedia.org/wiki/CAN_bus) from the [ECAN-W01](https://www.cdebyte.com/products/ECAN-W01) into [OpenCPN](https://opencpn.org/).
